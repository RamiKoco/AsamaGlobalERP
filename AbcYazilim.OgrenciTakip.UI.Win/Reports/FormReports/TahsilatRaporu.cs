...
namespace AbcYazilim.OgrenciTakip.UI.Win.Reports.FormReports
{
    public partial class TahsilatRaporu : BaseRapor
    {
        ...
        protected override void Listele()
        {
            ...
            using (var bll = new TahsilatRaporuBll())
            {
                tablo.GridControl.DataSource = bll.List(x =>
                    ...
                    iptalDurumu.Contains(x.OdemeBilgileri.Tahakkuk.Durum
                        ? IptalDurumu.DevamEdiyor
                        : IptalDurumu.IptalEdildi) &&
        ...
        protected override void ShowEditForm()
        {
            ...
            ShowEditForms<MakbuzEditForm>.ShowDialogEditForm(KartTuru.Tahakkuk, entity.MakbuzId,
                entity.MakbuzTuru,entity.MakbuzHesapTuru,
