...
namespace AbcYazilim.OgrenciTakip.UI.Win.GenelForms
{
    public partial class GirisForm : XtraForm
    {
        ...
        private void Yukle()
        {
            ...
            Functions.GeneralFunctions.CreateConnectionString("AbcYazilim_OgrenciTakip_Yonetim", server,
                kullaniciAdi, sifre, yetkilendirmeTuru);
        ...
        private void CreateConnection()
        {
            ...
            Functions.GeneralFunctions.CreateConnectionString(kod, server,
                kullaniciAdi, sifre, yetkilendirmeTuru);
