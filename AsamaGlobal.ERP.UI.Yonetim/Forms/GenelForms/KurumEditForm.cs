...
namespace AbcYazilim.OgrenciTakip.UI.Yonetim.Forms.GenelForms
{
    public partial class KurumEditForm : BaseEditForm
    {
        ...
        protected override bool EntityInsert()
        {
            ...
            Win.Functions.GeneralFunctions.CreateConnectionString(txtKod.Text, txtServer.Text,
                txtKullaniciAdi.Text.ConvertToSecureString(), txtSifre.Text.ConvertToSecureString(),
                txtYetkilendirmeTuru.Text.GetEnum<YetkilendirmeTuru>());

            if (!Functions.GeneralFunctions.CreateDatabase<OgrenciTakipContext>
                ("Lütfen Bekleyiniz.",
            ...
            Win.Functions.GeneralFunctions.CreateConnectionString("AbcYazilim_OgrenciTakip_Yonetim",
                txtServer.Text,
