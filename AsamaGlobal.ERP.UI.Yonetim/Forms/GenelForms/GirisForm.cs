...
namespace AbcYazilim.OgrenciTakip.UI.Yonetim.Forms.GenelForms
{
    public partial class GirisForm : XtraForm
    {
        ...
        private void Giris()
        {
            ...
            Win.Functions.GeneralFunctions.CreateConnectionString("AbcYazilim_OgrenciTakip_Yonetim", txtServer.Text,
                txtKullaniciAdi.Text.ConvertToSecureString(), txtSifre.Text.ConvertToSecureString(),
                txtYetkilendirme.Text.GetEnum<YetkilendirmeTuru>());

            if (!Functions.GeneralFunctions.CreateDatabase<OgrenciTakipYonetimContext>
                ("Lütfen Bekleyiniz.",
