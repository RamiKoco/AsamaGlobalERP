...
using AsamaGlobal.Dal.Base;
using AsamaGlobal.Dal.Interfaces;
using AsamaGlobal.ERP.Model.Entities.Base.Interfaces;
using DevExpress.Utils.Extensions;

namespace AsamaGlobal.ERP.Bll.Functions
{
   public static class GeneralFunctions
    {
        ...
        {
            return ConfigurationManager.ConnectionStrings["ERPContext"].ConnectionString;
