...
{
    public class OdemesiGecikenAlacaklarRaporuBll : BaseHareketBll<OdemeBilgileri, ERPContext>
    {
            ...
            return List(filter, x => new
            {
                ...
                Toplamlar = x.MakbuzHareketleri.GroupBy(y => y.OdemeBilgileriId).DefaultIfEmpty().Select(y => new
                {
                    ...
                    Tahsilde = y.Where(c => c.BelgeDurumu == BelgeDurumu.AvukataGonderme ||
                                                              ...
                                                              c.BelgeDurumu == BelgeDurumu.BlokeyeAlma).Select(c => c.IslemTutari).DefaultIfEmpty(0).Sum() - x.MakbuzHareketleri.Where(c => c.BelgeDurumu == BelgeDurumu.KismiAvukatYoluylaTahsilEtme ||
                    ...
                    SonIslemYeri = y.OrderByDescending(z => z.Id).Select(z => z.Makbuz.AvukatHesapId != null ? z.Makbuz.AvukatHesap.AdiSoyadi : z.Makbuz.BankaHesapId != null ? z.Makbuz.BankaHesap.HesapAdi : z.Makbuz.CariHesapId != null ? z.Makbuz.CariHesap.CariAdi : z.Makbuz.KasaHesapId != null ? z.Makbuz.KasaHesap.KasaAdi : z.Makbuz.SubeHesap.SubeAdi).FirstOrDefault()
                }).FirstOrDefault(),
