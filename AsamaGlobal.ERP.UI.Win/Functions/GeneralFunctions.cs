...
using AbcYazilim.OgrenciTakip.UI.Win.Properties;
   ...
   public static class GeneralFunctions
    {
            ...
            SecureString secureSifre, SecureString secureGizliKelime)
        {
            ...
            using (var bll = new MailParametreBll())
            {
                ...
                {
                    From = new MailAddress(entity.Email, "Abc Yazılım Öğrenci Takip Programı"),
                    To = { email },
                    Subject = "Abc Yazılım Öğrenci Takip Programı Kullanıcı Bilgileri",
                    IsBodyHtml = true,
                    Body = "Abc Yazılım Öğrenci Takip Programına Giriş İçin Gereken Kullanıcı Adı, Şifre, Gizli Kelime Bilgileri Aşağıdadır.<br/>" + 
