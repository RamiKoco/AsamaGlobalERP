    ...
    public static class FileFunctions
    {
        public static void FormSablonKaydet(this string sablonAdi, int left, int top, int width, int height, FormWindowState windowState)
        {
            try
            {
                ...
                writer.WriteComment("Asama Global Tarafından Oluşturuldu");
        ...
        public static void TabloDisariAktar(this GridView tablo, DosyaTuru dosysTuru, string dosyaFormati, string excelSayfaAdi = null)
        {
