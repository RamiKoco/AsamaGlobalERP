...
using GeneralFunctions = AsamaGlobal.ERP.UI.Win.Functions.GeneralFunctions;
...
namespace AsamaGlobal.ERP.UI.Win.Forms.TahakkukForms
{
    public partial class TahakkukEditForm : BaseEditForm
    {
        ...
        protected override void NesneyiKontrollereBagla()
        {
            ...
            txtSonrakiDonemKayitDurumuAciklama.Text = entity.SonrakiDonemKayitDurumAciklama;
        ...
        protected override void GuncelNesneOlustur()
        {
            CurrentEntity = new Tahakkuk
            {
                ...
                SonrakiDonemKayitDurumAciklama = txtSonrakiDonemKayitDurumuAciklama.Text,
        ...
        protected override bool BagliTabloHataliGirisKontrol()
        {
            ...
            {
                tabAlt.SelectedPage = pageGeriÖdemeBilgileri;
        ...
        private bool DurumKontrol()
        {
            ...
            {
                Messages.UyariMesaji("Eğitim Hizmet Alınmadığı için Tahakkuk Pasif Duruma Alınacaktır.");
        ...
        protected override void Yazdir()
        {
            ...
            var iletisimBilgileri = _iletisimBilgileriTable.Tablo.DataController.ListSource.Cast<IBaseEntity>()
                .EntityListConvert<IletisimBilgileriR>();
            var hizmetBilgileri = hizmetBilgileriTable.Tablo.DataController.ListSource.Cast<IBaseEntity>()
                .EntityListConvert<HizmetBilgileriR>();
            var indirimBilgileri = indirimBilgileriTable.Tablo.DataController.ListSource.Cast<IBaseEntity>()
                .EntityListConvert<IndirimBilgileriR>();
            var odemeBilgileri = odemeBilgileriTable.Tablo.DataController.ListSource.Cast<IBaseEntity>()
                .EntityListConvert<OdemeBilgileriR>();
            var geriOdemeBilgileri = geriOdemeBilgileriTable.Tablo.DataController.ListSource.Cast<IBaseEntity>()
                .EntityListConvert<GeriOdemeBilgileriR>();
            var eposBilgileri = _eposBilgileriTable.Tablo.DataController.ListSource.Cast<IBaseEntity>()
                .EntityListConvert<EposBilgileriR>();
            ShowListForms<RaporSecim>.ShowDialogListForm(KartTuru.Rapor, false,RaporBolumTuru.TahakkukRaporlari, ogrenciBilgileri, iletisimBilgileri,
                hizmetBilgileri, indirimBilgileri, odemeBilgileri, geriOdemeBilgileri, eposBilgileri);
        ...
        protected override void Control_SelectedPageChanged(object sender, SelectedPageChangedEventArgs e)
        {
            ...
            else if (e.Page == pageGeriÖdemeBilgileri)
                geriOdemeBilgileriTable.Tablo.GridControl.Focus();
        }
    }
}