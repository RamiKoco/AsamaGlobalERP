        ...
        protected override void Tablo_CustomSummaryCalculate(object sender, CustomSummaryEventArgs e)
        {
            ...
            switch (item.FieldName)
            {
                case "colUcretliOrtalama":
                    ...
                    if (e.IsGroupSummary)
                    {
                        var ucretliOgrenci = Convert.ToDecimal(Tablo.GetGroupSummaryValue(e.GroupRowHandle,
                            (GridGroupSummaryItem)Tablo.GroupSummary["UcretliOgrenci"]));
                        var netUcret = Convert.ToDecimal(Tablo.GetGroupSummaryValue(e.GroupRowHandle,
                            (GridGroupSummaryItem)Tablo.GroupSummary["NetUcret"]));
                ...
                case "colUcretsizDahilOrtalama":
                    ...
                    if (e.IsGroupSummary)
                    {
                        var ogrenciSayisi = Convert.ToDecimal(Tablo.GetGroupSummaryValue(e.GroupRowHandle,
                            (GridGroupSummaryItem)Tablo.GroupSummary["ToplamOgrenci"]));
                        var netUcret = Convert.ToDecimal(Tablo.GetGroupSummaryValue(e.GroupRowHandle,
                            (GridGroupSummaryItem)Tablo.GroupSummary["NetUcret"]));
                ...
                case "colSinifOrtalama":
                    ...
                    if (e.IsGroupSummary)
                    {
                        var ogrenciSayisi = Convert.ToDecimal(Tablo.GetGroupSummaryValue(e.GroupRowHandle,
                            (GridGroupSummaryItem)Tablo.GroupSummary["ToplamOgrenci"]));
                        var sinifSayisi = Convert.ToDecimal(Tablo.GetGroupSummaryValue(e.GroupRowHandle,
                            (GridGroupSummaryItem)Tablo.GroupSummary["SinifSayisi"]));
