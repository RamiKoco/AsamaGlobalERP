...
namespace AbcYazilim.OgrenciTakip.UI.Win.UserControls.UserControl.CariEditFormTable
{
    public partial class BilgiNotlariTable : BaseTablo
    {
        ...
        {
            tablo.GridControl.DataSource = ((BilgiNotlariBll)Bll).List(x => x.CarilerId == OwnerForm.Id).ToBindingList<BilgiNotlariL>();
        }
