    ...
    public partial class HizmetBilgileriTable : BaseTablo
    {
        ...
        protected internal override bool HataliGiris()
        {
            ...
            for (int i = 0; i < tablo.DataRowCount; i++)
            {
                ...
                {
                    tablo.FocusedRowHandle = i;
                    Messages.HataMesaji($"{entity.HizmetAdi} Kartına Uygulanan İndirimlerin Toplammı Kartın Toplam Tutarını Aşmaktadır.");
                    return true;
                }
            }
        ...
        protected override void HareketSil()
        {
            ...
            {
                Messages.HataMesaji("Bu Hizmet Kartına Ait İptal Edilmiş İndirim Bulunmaktadır. Hizmet Kartı Silinemez");
                return;
            }
